 ...
 * http://dev.mysql.com/downloads/connector/j/ 3. Add the Connector/J JAR to
 * your buildpath. This allows your application to use the Connector/J library.
 * You can add the JAR using either of the following methods: A. When creating a
 * new Java project, on the "Java Settings" page, go to the "Libraries" tab.
 * Click on the "Add External JARs" button. Navigate to the Connector/J JAR. On
 * Windows, this looks something like: C:\Program Files (x86)\MySQL\Connector.J
 * 8.0\mysql-connector-java-8.0.16-bin.jar B. If you already have a Java project
 * created, then go to your project properties. Click on the "Java Build Path"
 * option. Click on the "Libraries" tab, click on the "Add External Jars"
 * button, and navigate to the Connector/J JAR. 4. Update the "private final"
 * variables below.
 */
public class ConnectionManager {
	...
	private final String schema = "AmazonReviews";
