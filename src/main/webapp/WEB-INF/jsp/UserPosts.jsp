		...
		<c:forEach items="${posts}" var="post">
			<div class="card post-card">
				<div class="card-body">
					...
					<p class="card-text">Total Interactions:
						${post.getNumInteractions()}</p>
					<p class="card-text">Active: ${post.isActive()}</p>

					<!-- Button group with view and delete buttons -->
					<div class="d-flex">
						<!-- View button -->
						<a href="view_post?postId=${post.getPostId()}"
							class="btn btn-primary">View Post</a>
						<!-- Delete button -->
						<form action="my_posts" method="post" class="deleteButton">
